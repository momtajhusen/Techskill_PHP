<?php 
 session_start();
 $_SESSION["on_page"] = "my_whistles.php";
...
<div class="bg-danger profile-btn-box d-none" style="width:175px; position:absolute;top:85px;right:15px;z-index:100;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
  <div class="bg-light w-100 d-flex justify-content-center align-items-center flex-column">
    <a href="../../index.php" class="p-1 w-100 profile_menu pl-2">Home</a>
     ...
     <a href="my_whistles.php" class="p-1 w-100 profile_menu pl-2" style="background:black;color:white;">My Wishlish</a>
...
<div class="content">
    ...
    <div class="row m-0" style="background:#ECF6FD;height:auto" >
        ...
        <div class="container-col header-transparant pb-4 col-12 d-flex flex-wrap justify-content-center align-items-center" style="background:#FEF8EF;height:auto;position:relative;">
          ...
          <div class="d-flex flex-wrap justify-content-center align-items-center" style="width:90%;height:150px;">
             <b style="font-size:30px;">MY WHISTLES COURSE</b>
          </div>
               ...
               // Course Details Reteive
                ...
                while($all_course = $get_course_response->fetch_assoc())
                {
                  ...
                  if($user_email != "User not login")
                  {
                   ...
                   echo '<div class="card container-video animate__animated m-2 '.'video_'.$course_id.'" course_id="'.$course_id.'" style="position:relative;">
                   <a href="../inroll.php">
          ...
          $.ajax({
            ...
            success : function(response){
              if(response.trim() == "session set"){
                location.replace("../pay_method.php");
              }
            }
          });
...
$(document).ready(function(){
  var course = $(this).find(".course-name").html();
   ...
   <b style="font-size:12px;">Your Whistles <i class="fa fa-heart whistles-icon p-2 mt-2" aria-hidden="true" style="cursor:pointer"></i> course will be appear here.</b>\
   <p class="p-1" style="font-size:13px;">You are not whistles any courses Yet.</p>\
</div>'); 
   }
});
    ...
    $(this).click(function(){
      if($(this).css("color") == "rgb(33, 37, 41)"){
       ...
       $.ajax({
           ...
           success:function(response){
             if(response.trim() != "Please Try"){
     
              if($(".video_"+course_id+"").addClass("d-none"))
              {
...
$(window).resize(function(){
  ...
  if ((width <= 768  )) {
    window.location.href = "../my_whistles.php";
}
});

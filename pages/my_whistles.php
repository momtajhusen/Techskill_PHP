...
<span id="user_span" user="<?php echo $user_email; ?>"></span>
    ...
    <div class="p-3 d-md-none d-flex text-light  justify-content-between align-items-center" style="font-size:18px;background:#03386F;">
        <a href="profile.php"> <b class="text-light"><i class="fa fa-angle-left mr-3" aria-hidden="true"></i>My whistles</b></a>
    </div> 
...
<?php
  ...
  while($course_response = $course_data->fetch_assoc()){
    ...
    echo '
    <div class="d-flex mt-3 container-video animate__animated '.'video_'.$course_id.'" course_id="'.$course_id.'" style="width:92%; height:90px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;position:relative;">
       ...
       $.ajax({
           ...
           success:function(response){
             ...
             if(response.trim() != "Please Try"){
                 $(".video_"+course_id+"").removeClass("d-flex");
...
$(document).ready(function(){
 ...
 $(window).resize(function(){
  ...
  if ((width >= 768  )) {
    window.location.href = "pc/my_whistles.php";
}
});

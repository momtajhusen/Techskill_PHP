...
<div class="sigin_box">
     <div id="header" class="header   w-100 pt-3 pb-1  d-flex justify-content-center align-items-center flex-column">
         <div style="background-image: url('../image/verification.png'); " class="logo-box rounded-circle mb-2"></div>
         <h4 class="text-light">Gmail Verify</h4>
       ...
       <form class="verify_form w-100 mt-3 pt-3 pb-1 d-flex justify-content-center align-items-center flex-column" enctype="multipart/form-data">
          ...
          <div class="mb-2 w-75">
             <button class="active-btn animate__animated animate__zoomInDown animate__slow  w-100 btn mb-2" style="background-color:#B689B0;">submit</button>
          </div>

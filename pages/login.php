   ...
   <span class="ml-3 ">Login with Facebook</span>
    ...
    ?>
        ...
        <div class="text-light d-flex mt-3 ">
            <hr class="p-0 mr-2" style="margin-left:40px;width:32%;background:#888;"><span style="color:#888;">OR</span>
            <hr class="p-0 ml-2 mr-0" style="width:32%;background:#888;">
        </div>
        <div class="w-100" align="center" style="cursor:pointer;">
            <div class="rounded form_email_btn d-flex justify-content-beetwen align-items-center mt-3 pl-1"
                style="background-color:#888;width:80%;height:45px;">
        ...
        <div class="w-100" align="center" style="cursor:pointer;">
            <div class="rounded form_email_btn d-flex justify-content-center align-items-center mt-3 pl-1"
                style="border:1px solid #990026;width:80%;height:45px;">
   ...
   <span class="ml-3 ">Login width Gmail</span>
    ...
    ?>
        ...
        <form class="login_form w-100 mt-1 pb-1 d-flex align-items-center flex-column" enctype="multipart/form-data">
            ...
            <div
                class="mb-3 w-75 pr-4 input-div d-flex justify-content-center align-items-center animate__animated animate__zoomIn animate__slow animate__delay-2s">
                <i class="fa fa-envelope-o" style="font-size:20px; color:white;" aria-hidden="true"></i>
                <input type="email" required name="email" class="username user-email py-2 w-100 pl-3"
                    placeholder="Email">
            </div>

            <div
                class="mb-2 w-75 pr-4 input-div d-flex justify-content-around align-items-center animate__animated animate__zoomIn animate__slow animate__delay-3s">
                <i class="fa fa-key animate__animated animate__swing animate__infinite animate__slower 3s"
            ...
            <a href="forget_password.php"
                class="my-1 w-75 d-flex justify-content-end align-items-end animate__animated animate__slideInRight animate__slow animate__delay-4s">Forget
                password ?</a>

            <div class="mb-2 w-75">
                <button type="submit" id="submit" class="mt-2 text-light  font-weight-bold submit  w-100 btn"
                    style="background-color:#990026;">Login</button>
            </div>



            <a href="signup.php">
                <div class="mt-1 text-light w-100 btn"><b>Create an New account</b></div>
            </a>
        ...
        $(".login_form").submit(function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function beforeSend() {
                    $("#submit").html(
                        '<i class="fa fa-circle-o-notch fa-spin" style="font-size:20px;color:white"></i> Loading'
                    );
                ...
                success: function(response) {
                    ...
                    if (response.trim() == "Login Success") {
                        $("#submit").html(
                            "<i class='fa fa-check' style='font-size:20px;color:white'></i> success"
                        );

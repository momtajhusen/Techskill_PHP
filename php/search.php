 ...
 if($_SERVER['REQUEST_METHOD'] == "POST")
 {
  ...
  if($get_video_response = $db->query($video_data)){
    ...
    while($video_all_data = $get_video_response->fetch_assoc())
    {
      ...
      echo '
      <a href="pages/inroll.php" id="container-video" course_id="'.$course_id.'" class="d-flex container-video mb-2" style="width:90%;height:95px;cursor:pointer;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;position:relative;">

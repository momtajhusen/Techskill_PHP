  ...
  <header class="d-flex px-3 justify-content-between align-items-center" style="z-inddex:100;">
    ...
    <div class="login_profile_box d-none d-md-block">
      <div class="">
        ...
        <div class="profile-btn px-1 bg-light d-flex justify-content-around align-items-center" style="height:40px;cursor:pointer;"> <i class="fa fa-user mx-2" aria-hidden="true"></i> <span class="profile_span">Profile</span> <i class="fa fa-caret-down mx-2" aria-hidden="true"></i>
        </div>
      </div>
    </div>
  ...
  <div class="content">
    ...
    <div class="row pl-2 m-0 video-box" style="background:#ECF6FD;height:auto">
      ...
      <div class="container-col shadow-none col-12 d-flex flex-wrap justify-content-center align-items-center" style="height:auto;position:relative;">
        ...
        <div class="recoment mb-2 d-md-none text-light position-sticky" style="top:0px;left:0px; width:100%; background:#03386F; z-index:1;"><b><i>Recommended Course For
              You</i></b></div>
    ...
    <div class="container text-center text-md-left mt-5 ">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
          <p class="text-light">
            <i class="fas fa-home mr-3"></i> Nepal Sirha, Majhuliya - 8
          </p>
          <p class="text-light">
            <i class="fas fa-envelope mr-3"></i> mumtaz666raza@gmail.com
          </p>
          <p class="text-light">
            <i class="fas fa-phone mr-3"></i> + 977 9815759505
          </p>
          <p class="text-light">
          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              if (response.trim(search).match("paid-img")) {
                ...
                if (user_name != "") {
                  user_name = "<b class='font-weight-bold mb-1'>" +
                    user_name + "</b>";
                } else {
                  user_name = "";
                }
                ...
                $(".search-result-box").html(
                  "<div class='alert-danger p-2 px-4 d-flex justify-content-center align-items-center flex-column' style='width:90%'>" +
                  user_name +
                  "<p class='font-weight-bold mb-1'> No matching courses Name  </p> <p>Try a diffrent search term</p></div>"
                );
              }
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (response.trim(search).match("paid-img")) {
              ...
              var user_name = $("#user_span").attr("user_name");
              if (user_name != "") {
                user_name = "<b class='font-weight-bold mb-1'>" + user_name +
                  "</b>";
              } else {
                user_name = "";
              }
